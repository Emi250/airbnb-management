    ...
    <div className="flex flex-col gap-6 p-6 md:p-8">
      ...
      <div className="grid gap-6 md:grid-cols-2 xl:grid-cols-3">
          ...
          <Card key={property.id} className="flex flex-col">
            ...
            <CardContent className="flex-1">
              <div className="grid grid-cols-2 gap-4 text-sm">
                <div className="flex flex-col gap-1 bg-slate-50 p-3 rounded-md">
        ...
        {activeProperties.length === 0 && (
          <div className="col-span-full flex flex-col items-center justify-center py-12 text-center border-2 border-dashed rounded-lg bg-slate-50/50">
            <Building className="h-12 w-12 text-muted-foreground/50 mb-4" />
            <h3 className="text-lg font-medium text-slate-900">No hay propiedades activas</h3>
